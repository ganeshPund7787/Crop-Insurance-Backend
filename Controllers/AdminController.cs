...
public class AdminController : ControllerBase
{
    ...
    // ─── PUT api/admin/agents/{agentProfileId}/verify ──────────────────────
    [HttpPut("agents/{agentProfileId:guid}/verify")]
    public async Task<IActionResult> VerifyAgent(Guid agentProfileId)
    {
        await _agentService.VerifyAgentAsync(agentProfileId);
